export const fuses = {
  rightBank: [
    ...
    {
      3: "Instrument cluster, headlight range adjustment, telephone, oil level sensor",
      fuse: 7.5,
    },
    {
      4: "Electronic control unit for ABS/ESC",
      fuse: 5,
    },
    {
    ...
    {
      9: "Operating controls for the heating, electronic control unit for air conditioning system, park distance control, window lift, engine cooling fan, washing nozzles",
      fuse: 5,
    },
    {
      10: "DC-DC converter",
    ...
    {
      16: "Power steering, speedometer, engine control unit",
      fuse: 5,
    },
    {
      17: "Radio (START-STOP), separate daytime running lights",
      fuse: 7.5,
    },
    {
      18: "Mirror heater",
    ...
    {
      22: "Operating controls for the heating, electronic control unit for air conditioning system, telephone, instrument cluster, steering angle sender, multi-function steering wheel, ignition key removal lock",
      fuse: 7.5,
    },
    {
  ...
  leftBank: [
    ...
    {
      35: "Switch illumination, number plate light, parking light, headlamp washer system",
      fuse: 5,
    },
    {
      36: "Main beam",
